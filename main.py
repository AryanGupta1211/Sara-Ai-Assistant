import os
from agent.ai_agent import ask_agent
from utils.speech_to_text import record_audio, transcribe_with_groq
...
def process_audio_and_chat():
    ...
    while True:
        try:
            ...
            user_input = transcribe_with_groq(audio_filepath=audio_filepath)
            ...
            voice_of_sara = text_to_speech_with_elevenlabs(response, output_filepath="final.mp3")
...
with gr.Blocks() as demo:
    gr.Markdown("<h1 style='color: orange; text-align: center;  font-size: 4em;'> 👧🏼 Sara – Your Personal AI Assistant</h1>")
